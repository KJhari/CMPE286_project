...
app.onSync(async (body) => {
  try {
    const devices = await axios.get(` https://cced-2601-646-a080-7c60-19f1-25cf-4dcc-cdde.ngrok-free.app/discover/googleAssistant`);
...
app.onQuery(async (body) => {
  ...
  for (const device of intent.payload.devices) {
    ...
    try {
      const status = await axios.get(` https://cced-2601-646-a080-7c60-19f1-25cf-4dcc-cdde.ngrok-free.app/query/googleAssistant?id=${deviceId}`);
...
app.onExecute(async (body) => {
  ...
  for (const command of intent.payload.commands) {
    for (const device of command.devices) {
      ...
      try {
        const resDeviceCloud = await axios.post(` https://cced-2601-646-a080-7c60-19f1-25cf-4dcc-cdde.ngrok-free.app/toggle/googleAssistant`, payload);
